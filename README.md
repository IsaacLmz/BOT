...
5)- pkg install ffmpeg -y && pkg install tesseract -y && pkg install python -y
6)- pkg install ffmpeg -y && pkg install wget -y
7)- pkg install imagemagick
8)- git clone https://github.com/Makabro225/kitzia-md
9)- cd kitzia-md
10)- pkg install yarn
11)- yarn
12)- npm start
