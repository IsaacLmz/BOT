...
break
		case 'deletevoto': case'delvote': case 'hapusvote': {
            ...
            break
                     case 'namegp':
		             if (args.length < 1) return m.reply (`el nombre actual del grupo es: *${groupName}*`)
		             break
            case 'ephemeral': {
                if (!m.isGroup) throw mess.group
                if (!isBotAdmins) throw mess.botAdmin
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                m.reply(`Envie este Broadcast a ${anu.length} Chat grupal, hora de finalización ${anu.length * 1.5} segundos`)
                for (let i of anu) {
                    await sleep(1500)
                    let btn = [{
                                urlButton: {
                ...
                m.reply(`Envío exitoso de difusión a ${anu.length} Grupo(s)`)
            }
            break
		...
		m.reply('Broadcast enviada')
            ...
            break
            case 'infochat': {
                if (!m.quoted) m.reply('Reply mensaje')
...
case 'adioslepidoxdddd':
	...
	break
            case 'preguntabot':
				if (!q) return m.reply(`Usar ${command} texto\n\nEjemplo : ${command} soy god?`)
...
case 'califica':
				...
				if (!q) return m.reply(`Usar ${command} text\n\nEjemplo : ${command} mi foto`)
...
message = await prepareWAMessageMedia({ image : { url: anu.thumbnail } }, { upload:   yol.waUploadToServer })
	    ...
	    case 'getmusic': {
                ...
                if (!m.quoted) return m.reply('Responde a mi mensaje')
...
╰───────────────┈ ⧉`,
          ...
          listType: 1
		   ...
		   case 'bass': case 'blown': case 'deep': case 'saturado': case 'fast': case 'fat': case 'nightcore': case 'reversa': case 'robot': case 'lento': case 'suave': case 'ardilla':
                ...
                yol.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : tovn })
                fs.unlinkSync(ran)
                })
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
        ...
        if (stderr.trim()) m.reply(stderr)
            ...
            break
case 'menu':
await yol.send5ButImg(from, `Hola ${pushname} 💫\n\nMe llamo ${botname}, Soy Kitzia, una bot de WhatsApp hecha a base de NodeJs & Python\nSi encuentras algun error, informe a mi propietario para que se solucione de inmediato\nInfo principal:!!\n\n• Version Qr : *Baileys-MD*.\n• Prefix : ( ${prefix} )\n• Tiempo de Servidor : ${runtime(process.uptime())} \n• Fecha del servidor : ${moment.tz('America/Guayaquil').format('DD/MM/YY')}\n•Gracias por preferirme como su bot de confianza, trataré de ayudar en muchas cosas` + '' + lang.infobot(prefix), `© ${footer}`,thumb2, [{"urlButton": {"displayText": "Script bot","url": `${sc}`}},{"urlButton": {"displayText": "Base para Devs","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Menu lista","id": 'listmenu'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Reglas","id": 'reglas'}}] )
break
case 'allmenu':
	await yol.send5ButImg(from, `Hola ${pushname} 💘\n\n╭─⬣「 _*INFO BOT*_ 」⬣\n│ *Prefijo* :  ${prefix} \n│ *Nombre* : ${botname}\n│ *Owner* : ${ownername}\n│ *Runtime* : ${runtime(process.uptime())}\n│ *Lib* : Baileys-Md@4.0.0\n╰─⬣` + '\n' + lang.menu(prefix) , `${footer}`,thumb, [{"urlButton": {"displayText": "Script bot","url": `${sc}`}},{"urlButton": {"displayText": "Canal YT","url": `${myweb}`}},{"quickReplyButton": {"displayText": "ser premium","id": 'donar'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "ping and runtime","id": 'ping'}}] )
	break
case 'groupmenu':
	await yol.send5ButImg(from, `Hola ${pushname} 💘\n\n╭─⬣「 _*INFO BOT*_ 」⬣\n│ *Prefijo* :  ${prefix} \n│ *Nombre* : ${botname}\n│ *Owner* : ${ownername}\n│ *Runtime* : ${runtime(process.uptime())}\n│ *Lib* : Baileys-Md@4.0.0\n╰─⬣` + '\n' + lang.group(prefix) , `${footer}`,thumb, [{"urlButton": {"displayText": "Script bot","url": `${sc}`}},{"urlButton": {"displayText": "Canal YT","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Ping and Status","id": 'ping'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Menu descargas","id": 'downloadmenu'}}] )
	break
case 'downloadmenu':
	await yol.send5ButImg(from, `Hola ${pushname} 💘\n\n╭─⬣「 _*INFO BOT*_ 」⬣\n│ *Prefijo* :  ${prefix} \n│ *Nombre* : ${botname}\n│ *Owner* : ${ownername}\n│ *Runtime* : ${runtime(process.uptime())}\n│ *Lib* : Baileys-Md@4.0.0\n╰─⬣` + '\n' + lang.downloads(prefix) , `${footer}`,thumb, [{"urlButton": {"displayText": "Script bot","url": `${sc}`}},{"urlButton": {"displayText": "Canal YT","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Ping and Status","id": 'ping'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Menu busquedas","id": 'searchmenu'}}] )
	break
case 'searchmenu':
	await yol.send5ButImg(from, `Hola ${pushname} 💘\n\n╭─⬣「 _*INFO BOT*_ 」⬣\n│ *Prefijo* :  ${prefix} \n│ *Nombre* : ${botname}\n│ *Owner* : ${ownername}\n│ *Runtime* : ${runtime(process.uptime())}\n│ *Lib* : Baileys-Md@4.0.0\n╰─⬣` + '\n' + lang.search(prefix) , `${footer}`,thumb, [{"urlButton": {"displayText": "Script bot","url": `${sc}`}},{"urlButton": {"displayText": "Canal YT","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Ping And Status","id": 'ping'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Menu random","id": 'randommenu'}}] )
	break
case 'randommenu':
	await yol.send5ButImg(from, `Hola ${pushname} 💘\n\n╭─⬣「 _*INFO BOT*_ 」⬣\n│ *Prefijo* :  ${prefix} \n│ *Nombre* : ${botname}\n│ *Owner* : ${ownername}\n│ *Runtime* : ${runtime(process.uptime())}\n│ *Lib* : Baileys-Md@4.0.0\n╰─⬣` + '\n' + lang.random(prefix) , `${footer}`,thumb, [{"urlButton": {"displayText": "Script bot","url": `${sc}`}},{"urlButton": {"displayText": "Canal YT","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Ping And Status","id": 'ping'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "TextPro menu","id": 'logomenu'}}] )
	break
case 'logomenu':
	await yol.send5ButImg(from, `Hola ${pushname} 💘\n\n╭─⬣「 _*INFO BOT*_ 」⬣\n│ *Prefijo* :  ${prefix} \n│ *Nombre* : ${botname}\n│ *Owner* : ${ownername}\n│ *Runtime* : ${runtime(process.uptime())}\n│ *Lib* : Baileys-Md@4.0.0\n╰─⬣` + '\n' + lang.logomaker(prefix) , `${footer}`,thumb, [{"urlButton": {"displayText": "Script bot","url": `${sc}`}},{"urlButton": {"displayText": "Canal YT","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Ping And Status","id": 'ping'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Juegos menu","id": 'funmenu'}}] )
	break
case 'funmenu':
	await yol.send5ButImg(from, `Hola ${pushname} 💘\n\n╭─⬣「 _*INFO BOT*_ 」⬣\n│ *Prefijo* :  ${prefix} \n│ *Nombre* : ${botname}\n│ *Owner* : ${ownername}\n│ *Runtime* : ${runtime(process.uptime())}\n│ *Lib* : Baileys-Md@4.0.0\n╰─⬣` + '\n' + lang.funny(prefix) , `${footer}`,thumb, [{"urlButton": {"displayText": "Script bot","url": `${sc}`}},{"urlButton": {"displayText": "Canal YT","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Ping And Status","id": 'ping'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Conversion menu","id": 'convertmenu'}}] )
	break
case 'convertmenu':
	await yol.send5ButImg(from, `Hola ${pushname} 💘\n\n╭─⬣「 _*INFO BOT*_ 」⬣\n│ *Prefijo* :  ${prefix} \n│ *Nombre* : ${botname}\n│ *Owner* : ${ownername}\n│ *Runtime* : ${runtime(process.uptime())}\n│ *Lib* : Baileys-Md@4.0.0\n╰─⬣` + '\n' + lang.convert(prefix) , `${footer}`,thumb, [{"urlButton": {"displayText": "Script bot","url": `${sc}`}},{"urlButton": {"displayText": "Canal YT","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Ping and Status","id": 'ping'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "DataBase menu","id": 'mainmenu'}}] )
	break
case 'mainmenu':
	await yol.send5ButImg(from, `Hola ${pushname} 💘\n\n╭─⬣「 _*INFO BOT*_ 」⬣\n│ *Prefijo* :  ${prefix} \n│ *Nombre* : ${botname}\n│ *Owner* : ${ownername}\n│ *Runtime* : ${runtime(process.uptime())}\n│ *Lib* : Baileys-Md@4.0.0\n╰─⬣` + '\n' + lang.main(prefix) , `${footer}`,thumb, [{"urlButton": {"displayText": "Script bot","url": `${sc}`}},{"urlButton": {"displayText": "Canal YT","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Ping And Status","id": 'ping'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Creador menu","id": 'ownermenu'}}] )
	break
case 'ownermenu':
	await yol.send5ButImg(from, `Hola ${pushname} 💘\n\n╭─⬣「 _*INFO BOT*_ 」⬣\n│ *Prefijo* :  ${prefix} \n│ *Nombre* : ${botname}\n│ *Owner* : ${ownername}\n│ *Runtime* : ${runtime(process.uptime())}\n│ *Lib* : Baileys-Md@4.0.0\n╰─⬣` + '\n' + lang.ownermenu(prefix) , `${footer}`,thumb, [{"urlButton": {"displayText": "Script bot","url": `${sc}`}},{"urlButton": {"displayText": "Canal YT","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Ping And Status","id": 'ping'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Modificador","id": 'voicemenu'}}] )
	break
case 'voicemenu':
	await yol.send5ButImg(from, `Hola ${pushname} 💘\n\n╭─⬣「 _*INFO BOT*_ 」⬣\n│ *Prefijo* :  ${prefix} \n│ *Nombre* : ${botname}\n│ *Owner* : ${ownername}\n│ *Runtime* : ${runtime(process.uptime())}\n│ *Lib* : Baileys-Md@4.0.0\n╰─⬣` + '\n' + lang.voice(prefix) , `${footer}`,thumb, [{"urlButton": {"displayText": "Script bot","url": `${sc}`}},{"urlButton": {"displayText": "Canal YT","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Ping And Status","id": 'ping'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Instagram bot","id": 'instagram'}}] )
	break
case 'creditos':
await yol.send5ButImg(from, `` + '' + lang.thanksto(), `© ${footer}`,thumb, [{"urlButton": {"displayText": "Script bot","url": `${sc}`}},{"urlButton": {"displayText": "Canal YT","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Menu","id": 'menu'}},{"quickReplyButton": {"displayText": "Ping y actividad ","id": 'ping'}},{"quickReplyButton": {"displayText": "test","id": 'test'}}] )
break
case 'donar':
	await yol.send5ButImg(from, `` + '' + lang.donasi(), `${footer}`,thumb, [{"urlButton": {"displayText": "Script bot","url": `${sc}`}},{"urlButton": {"displayText": "Canal YT","url": `${myweb}`}}] )
	break
case 'entrargp':
	await yol.send5ButImg(from, `` + '' + lang.gprules(), `${footer}`,thumb, [{"urlButton": {"displayText": "Script bot","url": `${sc}`}},{"urlButton": {"displayText": "Tiktok bot","url": `${tiktok}`}}] )
	break
case 'reglas':
	await yol.send5ButImg(from, `` + '' + lang.rules(), `${footer}`,thumb, [{"urlButton": {"displayText": "Script bot","url": `${sc}`}},{"urlButton": {"displayText": "Pagina ofc","url": `${linkbot}`}}] )
	break
